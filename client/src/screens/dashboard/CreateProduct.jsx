...
const CreateProduct = () => {
  const { data = [], isLoading, isSuccess, isFetching } = useAllCategoriesQuery();
            ...
            <div className="w-full md:w-6/12 p-3">
              ...
              {!isLoading && isSuccess ? (
                data?.categories?.length > 0 && (
                  <select name="categories" id="categories" className="form-control" onChange={handleInput} value={state.category}>
